...
*These installation instructions were last tested on 15 Aug 2021. For more information on issues that may occasionally arise with the installation process, please see the [Troubleshooting](Troubleshooting.md) page. Thanks to Varun Tandon for updating these instructions!*

**These instructions are for Python 2, but Oppia now uses Python 3. Unless you need to work with the old Python 2 code, you should follow the [Python 3 instructions](Installing-Oppia-(Mac-OS;-Python-3).md) instead.**
