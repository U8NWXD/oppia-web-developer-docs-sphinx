...
* Before making the commit, do some sanity-checks:
  ...
  * Ensure that your code follows [the style rules](Coding-style-guide.md).
...
* After a while, check your pull request to see whether the CI checks have passed. If not, follow the instructions at [If your build fails](If-your-build-fails.md).
...
(See [If your build fails](If-your-build-fails.md) for some suggestions on what to do if you run into issues.)
