...
Inside your Ubuntu environment, follow the steps for [Linux](Installing-Oppia-(Linux;-Python-3).md).
...
Now, you can open the VM. Inside the VM, clone and install the Oppia repository from GitHub following the [Linux installation instructions](Installing-Oppia-(Linux;-Python-3).md) in order to set up Oppia in the VM.
